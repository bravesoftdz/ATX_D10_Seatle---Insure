...
ProcLibr:=what;
case what of
1:begin Caption:='Гарнизон/Область';
...
6:begin Caption:='Марка автотранспорта';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
7:begin Caption:='Источник финансирования';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
10:begin Caption:='Группа эксплуатации';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
11:begin Caption:='Место дислокации';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
15:begin Caption:='Страховые компании';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
16:begin Caption:='Вид перечисления';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
21:begin Caption:='Производитель ТС';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
22:begin Caption:='Коэффициент КО';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
23:begin Caption:='Территории использования (КТ)';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
24:begin Caption:='Период использования (КС)';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
...
25:begin Caption:='Мощность двигателя (КМ)';
if Main.UserRole<>INSURE_USER then
begin
    LbB_New.Enabled:=false;
    LbB_Edit.Enabled:=false;
