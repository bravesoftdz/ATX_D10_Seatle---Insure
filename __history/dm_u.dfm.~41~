object dm: Tdm
  ...
  object ADOQuery3: TADOQuery
    ...
    SQL.Strings = (
      ...
      'SUM(val) as probeg ,'
        ...
        'lim_value, dbo.tShinaProbeg.id_avt,dbo.tShinaAvt.date2,dbo.tShin' +
        'a.id'
      ''
      'FROM         '
      'dbo.tShinaProbeg '
      
        '  inner join dbo.tShinaAvt on dbo.tShinaProbeg.id_shin=dbo.tShin' +
        'aAvt.id_shin and dbo.tShinaProbeg.id_avt=dbo.tShinaAvt.id_avt'
      
        '  inner join dbo.tShina on dbo.tShina.id=dbo.tShinaProbeg.id_shi' +
        'n'
      '  inner join dbo.tShina_R on dbo.tShina_R.id=dbo.tShina.id_r'
      
        '  inner join dbo.tShina_Konst on dbo.tShina_Konst.id=dbo.tShina.' +
        'id_k'
      
        '  inner join dbo.tShina_Type on dbo.tShina_Type.id=dbo.tShina.id' +
        '_t'
      
        '  inner join dbo.tAvto on tAvto.id=dbo.tShinaAvt.id_avt and tAvt' +
        'o.id=dbo.tShinaProbeg.id_avt'
      '  INNER JOIN'
      ...
      ''
      'dbo.tShina.number,'
      'dbo.tShinaProbeg.id_avt,lim_value,dbo.tShinaAvt.date2 '
  ...
  object dss_osago: TDataSource
    DataSet = StoredProc_osago
    Left = 928
    Top = 504
  end
  object StoredProc_osago: TADOStoredProc
    Connection = ADO
    Parameters = <>
    Left = 920
    Top = 560
  end
  object tTerUse: TADOTable
    Connection = ADO
    TableName = 'tTerUse'
    Left = 824
    Top = 56
  end
  object dss_teruse: TDataSource
    DataSet = tTerUse
    Left = 888
    Top = 56
  end
  ...
  object dss_tKC: TDataSource
    DataSet = tKC
    Left = 896
    Top = 136
  end
  object ds_StoredProc3: TDataSource
    DataSet = StoredProc3
    Left = 16
    Top = 376
  end
