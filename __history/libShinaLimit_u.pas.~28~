...
type
  TfrmLidShinaLimit = class(TForm)
    ...
    procedure lim_value_editKeyPress(Sender: TObject; var Key: Char);
  private
    newRecord,firstKeyPress:boolean;
...
procedure TfrmLidShinaLimit.lim_value_editKeyPress(Sender: TObject;
  var Key: Char);
begin
