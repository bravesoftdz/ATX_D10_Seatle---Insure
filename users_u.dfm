object frmusers: Tfrmusers
  ...
  object GroupBox1: TGroupBox
    ...
    object pwd2_edit: TLabeledEdit
      ...
      EditLabel.Width = 120
      EditLabel.Height = 13
      EditLabel.Caption = #1055#1086#1076#1090#1074#1077#1088#1078#1076#1077#1085#1080#1077' '#1087#1072#1088#1086#1083#1103
      ParentCtl3D = False
      PasswordChar = '*'
      TabOrder = 2
    end
    object role_box: TComboBox
      Left = 8
      Top = 112
      Width = 393
      Height = 21
      TabOrder = 4
      OnKeyPress = role_boxKeyPress
      Items.Strings = (
        #1040#1076#1084#1080#1085#1080#1089#1090#1088#1072#1090#1086#1088
        #1059#1087#1088#1072#1074#1083#1077#1085#1080#1077' '#1089#1090#1072#1093#1086#1074#1082#1086#1081)
    end
  end
