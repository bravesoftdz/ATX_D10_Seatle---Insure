...
begin
  ...
  pathNameAll:=  'c:/setup_insure'+IntToStr(dm.verDB)+'.exe';
...
try
  ...
  if idFTP.Connected then
    try
    if fileNameUpdate='' then
      fileNameUpdate:='setup_insure.exe';
