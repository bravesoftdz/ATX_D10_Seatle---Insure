...
begin
 ...
 Label1.Caption:='Тип ТС';
Caption:='Базовая ставка';
 Mark_box.LookupSource:=dm.dss_typeTc;
 dm.tTypeTC.Open;
 dm.tTypeTC.Sort:='name';
DBGrid.Columns.Clear;
DBGrid.Columns.Add;
DBGrid.Columns[0].Title.Caption:='Коэффициент';
DBGrid.Columns[0].FieldName:='koef';
...
if Lib_what=26 then ADOLidr2.Sort:='id';
if Lib_what=3 then
